...
export const GridBackground: React.FC<GridBackgroundProps> = ({ 
  ...
  const gridStyles = useMemo(() => ({
    backgroundColor: `color-mix(in srgb, ${COLORS.background}, transparent ${100 - glassOpacity * 100}%)`,
    backgroundImage: `
      /* Noise texture */
      ${noiseSvgUrl},
      
      /* Main grid lines */
      linear-gradient(to right, color-mix(in srgb, ${COLORS.mainGrid}, transparent ${100 - gridOpacity * 100}%) 1px, transparent 1px),
      linear-gradient(to bottom, color-mix(in srgb, ${COLORS.mainGrid}, transparent ${100 - gridOpacity * 100}%) 1px, transparent 1px),
      
      /* Sub-grid lines */
      linear-gradient(to right, color-mix(in srgb, ${COLORS.subGrid}, transparent ${100 - gridOpacity * 100}%) 1px, transparent 1px),
      linear-gradient(to bottom, color-mix(in srgb, ${COLORS.subGrid}, transparent ${100 - gridOpacity * 100}%) 1px, transparent 1px),
      
      /* Faint tertiary lines for extra detail */
      linear-gradient(to right, color-mix(in srgb, ${COLORS.tertiaryGrid}, transparent ${100 - gridOpacity * 100}%) 1px, transparent 1px),
      linear-gradient(to bottom, color-mix(in srgb, ${COLORS.tertiaryGrid}, transparent ${100 - gridOpacity * 100}%) 1px, transparent 1px)
    `,
    backgroundSize: `
      /* Noise texture */
      200px 200px,
